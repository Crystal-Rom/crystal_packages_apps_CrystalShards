...
public class GeneralModsFragment extends PreferenceFragment
  {
    ...
    public GeneralModsFragment()
      {
        // Required empty public constructor
      }

    public static GeneralModsFragment newInstance()
      {
        return new GeneralModsFragment();
      }
    ...
    public void onCreate(Bundle savedInstanceState)
      {
        ...
        addPreferencesFromResource(R.xml.crystal_mod_general);
      }
